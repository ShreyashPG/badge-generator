...
export default function BadgeGeneratorPage(): JSX.Element {
  ...
  const copyMarkdown = () => {
    ...
    const md = `[![BadgesGenerator](data:image/svg+xml;base64,${base64})](https://badge-generator-vxfc.vercel.app/)`;
  ...
  const generateShareLink = () => {
    ...
    return `https://badge-generator-vxfc.vercel.app?${params.toString()}#/generator`;
  };
